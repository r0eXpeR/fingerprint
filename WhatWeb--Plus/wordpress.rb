...
matches [
    {:offset=>1, :search=>'body', :regexp=>/^WordPress ?([\d.]+)?/},
    {:offset=>1, :search=>'body', :regexp=>/wp-embed\.min\.js\?ver=([\d.]+)/},
    {:regexp=>/"[^"]+\/wp-content\/[^"]+"/, :name=>"wp-content", :certainty=>75},
    {:regexp=>/.wp-(?:content|includes)./, :search=>'body'},
    {:regexp=>/.xmlrpc\.php$/, :search=>'headers[x-pingback]'},
    {:regexp=>/<link rel=["']stylesheet["'] [^>]+.wp-(?:content|includes)./},
    {:regexp=>/<link[^>]+s\d+\.wp\.com/},
    {:regexp=>/rel="https:..api\.w\.org./, :search=>'headers[link]'},
    {:search=>"headers", :text=>'/xmlrpc.php'},
    ...
    {:url=>"/wp-cron.php"},
    {:url=>"/wp-login.php", :tagpattern=>"!doctype,html,head,title,/title,meta,link,link,script,/script,meta,/head,body,div,h1,a,/a,/h1,form,p,label,br,input,/label,/p,p,label,br,input,/label,/p,p,label,input,/label,/p,p,input,input,input,/p,/form,p,a,/a,/p,p,a,/a,/p,/div,script,/script,/body,/html"},
    ...
    {:url=>'/license.txt', :md5=>'405836dc36b41ce662dba3423eab616c'},
    {:url=>'/license.txt', :md5=>'b7d6694302f24cbe13334dfa6510fd02'},
    {:url=>'/license.txt', :text=>'WordPress'},
    {:url=>'/readme.htm', :text=>'WordPress'},
    {:url=>'/readme.html', :text=>'WordPress'},
    {:url=>'/readme.txt', :text=>'WordPress'},
    {:url=>'/robots.txt', :md5=>'5f685615bfec748c86a763b9ee8a442c'},
    {:url=>'/robots.txt', :md5=>'b138a3153b813846c14a8c7d8b538aa0'},
    {:url=>'/robots.txt', :text=>'WordPress'},
    {:url=>'/wp-admin/css/colors-classic.css', :text=>'WordPress'},
    {:url=>'/wp-admin/css/login.min.css', :md5=>'5986a1680538ac8e83d217027d57543f'},
    {:url=>'/wp-admin/images/WordPress-logo.png', :md5=>'c6b0f979b9e66fc338f4cb3853a5608a'},
    {:url=>'/wp-admin/images/w-logo-blue.png', :md5=>'7c129101ccaa73c604221737ce8380f1'},
    {:url=>'/wp-admin/images/wp-logo-2x.png', :md5=>'18ac0a741a252d0b2d22082d1f02002a'},
    {:url=>'/wp-admin/js/media-upload.dev.js', :md5=>'2a55cde57cdb0c810aec27fdc928e1ef'},
    {:url=>'/wp-admin/js/media-upload.dev.js', :text=>'WordPress'},
    {:url=>'/wp-content/plugins/akismet/akismet.js', :text=>'WordPress'},
    {:url=>'/wp-content/themes/classic/rtl.css', :text=>'WordPress'},
    {:url=>'/wp-content/themes/twentyeleven/readme.txt', :text=>'WordPress'},
    {:url=>'/wp-content/themes/twentyten/images/WordPress.png', :md5=>'cc452c1368589d88d26f306c49319340'},
    {:url=>'/wp-content/themes/twentyten/style.css', :text=>'WordPress'},
    {:url=>'/wp-includes/css/buttons.css', :text=>'WordPress'},
    {:url=>'/wp-includes/css/buttons.min.css', :md5=>'74ac6750d8faed75774166c72f88fcbf'},
    {:url=>'/wp-includes/js/jcrop/Jcrop.gif', :md5=>'5a8bfd37651305bdafbcf2cd51b0254b'},
    {:url=>'/wp-includes/js/jquery/jquery.js', :md5=>'8610f03fe77640dee8c4cc924e060f12'},
    {:url=>'/wp-includes/js/scriptaculous/wp-scriptaculous.js', :text=>'WordPress'},
    {:url=>'/wp-includes/js/tinymce/langs/wp-langs-en.js', :text=>'WordPress'},
    {:url=>'/wp-includes/js/tinymce/wp-tinymce.js', :text=>'WordPress'},
    {:url=>'/wp-includes/wlwmanifest.xml', :text=>'WordPress'},
    {:url=>'/xmlrpc.php', :md5=>'9ba4b71a75f877bef76ec6bb31f71df2'},
