...
matches [
    ...
    {:offset=>1, :regexp=>/(?: \| phpMyAdmin ([\d.]+)<\.title>|PMA_sendHeaderLocation\(|<link [^>]*href="[^"]*phpmyadmin\.css\.php)/},
    {:regexp=>/<form method="post" action="index\.php" target="_(top|parent)"><input type="hidden" name="phpMyAdmin" value="/},
    {:search=>"headers", :text=>'Set-Cookie: phpMyAdmin='},
    {:serach=>'headers', :regexp=>/pma_lang|phpMyAdmin/},
    {:text=>'/themes/pmahomme/img/logo_right.png'},
    {:text=>'<img src="./themes/original/img/logo_right.png" id="imLogo" name="imLogo" alt="phpMyAdmin" border="0" /></a>'},
    {:text=>'phpMyAdmin'},
    {:text=>'pma_password'},
    {:url=>'/phpmyadmin/favicon.ico', :md5=>'ebd8a51a6152d6da6436399bb4355488'},
    {:url=>'/phpmyadmin/themes/pmahomme/img/logo_right.png', :md5=>'6537bfe0438d4073b92f3e0a05dd3fb4'},
    {:url=>'/phpmyadmin/themes/pmahomme/jquery/jquery-ui-1.8.16.custom.css', :md5=>'2059c4c1ec104e7554df5da1edb07a77'},
